...
iter_max = 1
batch_size = 5000 #Total no. of test samples is 5000
pairs_per_img = 1  


dir_test = '/home/jakesabandal/Documents/Deeplearning/Datasets/MSCOCO/test2014'  # change to your own directory
...
def main(_):
    ...
    for i in range(iter_max):
        ...
        x_test, y_test = test_model.next_batch()
        y_test = np.reshape(y_test, [-1, 8])

        
        test = {'features': x_test, 'labels': y_test}
        pickle.dump(test, open("../data_test/test_"+str(i)+".p", "wb"))
