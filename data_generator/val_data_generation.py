...
iter_max = 1
file_size = 6400 #Validation samples is 100 iterations with a total of 6400 image pairs
pairs_per_img = 8  

dir_val = '/home/jakesabandal/Documents/Deeplearning/Datasets/MSCOCO/val2014'  # Change to your own directory
...
class DataSet(object):
    ...
    def next_batch(self):
        ...
        print (start)
        self.index_in_epoch += file_size / pairs_per_img
...
def main(_):
    ...
    for i in range(iter_max):
        x_val, y_val = val_model.next_batch()
        y_val = np.reshape(y_val, [-1, 8])
        
        val = {'features': x_val, 'labels': y_val}
        pickle.dump(val, open("../data_val/val_"+str(i)+".p", "wb"))
